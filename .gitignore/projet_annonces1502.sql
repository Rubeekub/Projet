...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 15 fév. 2024 à 09:17
...
(9, 11, 'img/gros-plan-beau-papillon-textures-interessantes-fleur-petale-orange_181624-7640.avif'),
(10, 11, 'img/jetee-au-bord-lac-hallstatt-autriche_181624-44201.avif');
...
--
ALTER TABLE `avatars`
  MODIFY `id_avatar` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `utilisateurs`
  MODIFY `id_utilisateur` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `annonces`
  ADD CONSTRAINT `FK3` FOREIGN KEY (`id_utilisateurs`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE CASCADE ON UPDATE CASCADE,
